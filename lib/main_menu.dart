  ...
  Widget build(BuildContext context) {
    return new Container(
      ...
      child: new ListView(
        ...
        children: <Widget>[
          _buildListItem("Certifications", Icons.folder_special, () {}),
          _buildListItem("Skills", Icons.pan_tool, () {}),
          _buildListItem("Reviews", Icons.people, () {}),
          _buildListItem("Previous Jobs", Icons.people, () {}),
          _buildListItem("Achievements", FontAwesomeIcons.trophy, () {}),
        ],
      ),
    );
  }
